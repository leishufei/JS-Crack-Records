...
function getRandomStr() {
    ...
    return e.length > 0 && (n = t.filter((function (t) {
        ...
        n[rangeRandomNumber([0, n.length], "int")]
}

function timesRandomStr(e, t) {
    for (var n = "", o = rangeRandomNumber(e, "int"), r = 0; r < o; r++) {
        n += getRandomStr(t)
    }
    return n
}

function repeatStr(e, t) {
    for (var n = "", o = 0; o < t; o++)
        n += e;
    return n
}

function timestampFormat(t) {
    var date = new Date(t);
    Y = date.getFullYear();
...
function u() {
    var e = timesRandomStr([32, 65], ["g"]);
    var t = p() / 1e3 - 14400
        , n = t.toString();
    var o = SHA256(e + n);
    var i = repeatStr(Math.floor(t / 100).toString(), 8);
    var l = f([o, i]);
    // var c = MD5;
    // c.update(l);
    var u = MD5(l);
...
function getSign(phoneNumber) {
    var n = u()
        , r = n
        , i = r[0]
        , time_ = timestampFormat(getTimestamp())
        , a = r[1] + "_" + "86" + phoneNumber + "_" + time_;
    // c()(a);
    var p = SHA1(a);
    return [i + "g" + p, time_]
}

console.log(getSign(15512345678))
