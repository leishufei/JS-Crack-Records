...
var hexcase = 0,
    b64pad = "",
    chrsz = 8,
    appId = "baec98a73c1bff796603cb2fa9d6d449";
var hexcase = 0;
var b64pad = "";
...
function srXY9Y1XQRaq7GPCj(mAfre3O9d, oywGO2usiQ) {
    var pqq15DU = p3cnrDIfVp(mAfre3O9d, oywGO2usiQ);
    // console.log(pqq15DU)
    return pqq15DU
}

function getParam(method, city, month,) {
    var obj = {};
    if (method === 'GETDAYDATA') {
        obj.city = city
        obj.month = month
    } else if (method === 'GETMONTHDATA') {
        obj.city = city
    } else {
    }
    param = srXY9Y1XQRaq7GPCj(method, obj)
    return param
}

function getData(param) {
    data = dSp17P6wE1CFXC6D(param)
    return data
}