...
class Zkh_Industrial_Supermarket():
    def __init__(self):
        ...
        self.index_url = "https://www.zkh360.com/"
        self.get_zkhst_url = "https://web.zkh360.com/zkhweb/zkhAuth/signToken?traceId={}"
        self.get_data_url = "https://web.zkh360.com/servezkhApi/search/1/product?traceId={}"
